...
INSERT INTO CorrectMap (correct_map_id,answer_id,correctness,npoints,msg,hint,hintmode,queuestate) VALUES 
    (83552ed0-8bdb-4fdd-9f4e-9bf162a630d8,'i4x-Medicine-HRP258-problem-e194bcb477104d849691d8b336b65ff6_3_1','correct',None,'','',None,None),
    (bf033fef-b220-4f69-8d56-27cfcf4e82f9,'i4x-Medicine-HRP258-problem-e194bcb477104d849691d8b336b65ff6_2_1','correct',None,'','',None,None);
...
INSERT INTO CorrectMap (correct_map_id,answer_id,correctness,npoints,msg,hint,hintmode,queuestate) VALUES 
    (e4c46632-137c-470f-8009-fb91619d5a0d,'i4x-Medicine-HRP258-problem-e194bcb477104d849691d8b336b65ff6_3_1','incorrect',None,'','',None,None),
    (ace84468-a40a-4504-ab67-f84c2c1fa631,'i4x-Medicine-HRP258-problem-e194bcb477104d849691d8b336b65ff6_2_1','incorrect',None,'','',None,None);
...
INSERT INTO State (state_id,seed,done,problem_id,student_answer,correct_map,input_state) VALUES 
    (6ee97dbe-8447-4420-bc1b-eff461f9d327,1,True,None,70725a11-403f-400a-b63e-84c6d132aa8e,e4c46632-137c-470f-8009-fb91619d5a0d,1adee9ea-4be0-419b-a2ce-7f570b66cd04),
    (6ee97dbe-8447-4420-bc1b-eff461f9d327,1,True,None,5be1502d-0f53-4cee-8676-a74539569e02,ace84468-a40a-4504-ab67-f84c2c1fa631,2a077c63-1e13-442a-b1cb-225e98acde92);
INSERT INTO Event (eventID,agent,event_source,event_type,ip,page,session,time,username,downtime_for,studentID,instructorID,courseID,seqID,gotoFrom,gotoDest,problemID,problemChoice,questionLocation,attempts,feedback,feedbackResponseSelected,rubricSelection,rubricCategory,videoID,videoCode,videoCurrentTime,videoSpeed,bookInteractionType,success,answer_id,hint,hintmode,correctness,msg,npoints,queuestate,correctMapFK,answerFK,stateFK) VALUES 
    ...
    ('null','null','null','null','null','null','null','null','null','null','null','null','null','null','null','null','null','null','null',2,'null','null','null','null','null','null','null','null','null','correct','null','null','null','null','null','null','null',bf033fef-b220-4f69-8d56-27cfcf4e82f9,e3dfc629-4562-4260-b001-789132b2c6b6,None);
